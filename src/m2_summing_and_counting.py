...
def run_test_sum_more_cosines():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = 0.724352  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(0, 6)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -1.413022  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(1, 11)
...
def run_test_count_sines_from():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = 7  # This is APPROXIMATELY the correct answer.
    answer = count_sines_from(-5, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 5  # This is APPROXIMATELY the correct answer.
    answer = count_sines_from(0, 7)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
